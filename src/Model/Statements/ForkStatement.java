...
public class ForkStatement implements IStatement{
    ...
    public ProgramState execute(ProgramState state) throws MyException {
        ...
        return new ProgramState(execStackc, ((Dict<String, IValue>)state.getSymbolTable()).deepClone(), state.getOutput(),statement, state.getFileTable(),state.getHeap(),state.getLockTable());
    }
